...
echo -e "  初始化脚本
  ${Green_font_prefix}1.${Font_color_suffix} 安装 常用命令（wget/git/lsof/bzip2/gcc/nginx）
  ...
  ${Green_font_prefix}10.${Font_color_suffix} 安装 proxychains
  ${Green_font_prefix}11.${Font_color_suffix} 安装 v2ary
————————————
 ${Green_font_prefix}12.${Font_color_suffix} 关闭 selinux
 ${Green_font_prefix}13.${Font_color_suffix} 设置 vim
 ${Green_font_prefix}14.${Font_color_suffix} 设置 时区
 ${Green_font_prefix}15.${Font_color_suffix} 设置 自定义alias
 ${Green_font_prefix}16.${Font_color_suffix} 设置 自定义zsh
————————————
 ${Green_font_prefix}17.${Font_color_suffix} 全部安装
 "
